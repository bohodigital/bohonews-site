...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-174624.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T174624Z-C8E2A6F4D1B9";
const slugs=[
  "cms-rapid-medicare-breakthrough-device-pathway-proposal-2026",
  "unalaska-harbor-sea-otter-harassment-review-2026",
  "usitc-lcd-glass-import-exclusion-order-tcl-2026",
  "epa-new-hampshire-emissions-inspection-plan-proposal-2026",
  "biomedical-science-patent-bar-category-a-eligibility-2026",
  "nrc-rule-comment-withholding-advisory-procedures-2026"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t174624z-c8e2a6f4d1b9",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t174624z-c8e2a6f4d1b9";
