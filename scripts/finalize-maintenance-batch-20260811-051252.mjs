...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-051252.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T051252Z-5E8A1C3D7F20";
const slugs=[
  "gao-federal-program-effectiveness-three-step-test-2026",
  "nih-oriva-human-based-research-office-2026",
  "smithsonian-caterpillar-2-3-million-stem-40-communities",
  "imf-ireland-growth-inflation-outlook-2026",
  "us-rental-homeowner-vacancy-rates-second-quarter-2026",
  "ncaa-division-i-commercial-uniform-patches-august-2026"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t051252z-5e8a1c3d7f20",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t051252z-5e8a1c3d7f20";
