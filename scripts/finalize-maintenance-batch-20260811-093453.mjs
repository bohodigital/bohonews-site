...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-093453.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T093453Z-7B2E5D9A4C61";
const slugs=[
  "ncaa-womens-lacrosse-penalty-rules-proposed-2026",
  "fda-tregzi-regulatory-t-cell-therapy-approval-2026",
  "national-recording-registry-2026-25-selections",
  "cambodia-growth-inflation-imf-2026-outlook",
  "401k-spousal-consent-withdrawals-gao-2026",
  "gao-pentagon-clean-audit-approach-2028-risks"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t093453z-7b2e5d9a4c61",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t093453z-7b2e5d9a4c61";
