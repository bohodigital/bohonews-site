...
const mediaRoot="/media/newsroom/2026/08/manual-20260811-071852";
...
const articleDefs=JSON.parse(readFileSync(join(root,"scripts/maintenance-batch-20260811-071852.json"),"utf8"));
