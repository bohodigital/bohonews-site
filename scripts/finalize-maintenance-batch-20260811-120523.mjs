...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-120523.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T120523Z-9C2E7A4D1B68";
const slugs=[
  "federal-tax-fraud-median-loss-546562-fy2025",
  "metro-bachelors-degree-rate-378-percent-acs-2024",
  "human-speech-neurons-grammar-context-nih-study-2026",
  "mauritius-growth-28-percent-debt-86-imf-2026",
  "from-these-lands-smithsonian-600-objects-2029",
  "ncaa-womens-soccer-college-cup-second-weekend-december-2026"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t120523z-9c2e7a4d1b68",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t120523z-9c2e7a4d1b68";
