...
if (!['activation','final'].includes(phase) || !sourceDistArg || !outputArg || !batchId || !expectedCommit || !previousReference) {
  throw new Error('Usage: node scripts/prepare-maintenance-deployment-20260810-055829.mjs <activation|final> <dist> <output> <batch-id> <commit> <previous-reference>');
}
...
const routes = [
  ...
  '/investigations/', '/crime-justice/', '/culture/', '/health-science/', '/technology/', '/us/',
