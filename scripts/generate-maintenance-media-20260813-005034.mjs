...
const root="public/media/newsroom/2026/08/manual-20260813-005034";
const assets=join(root,"assets");
const definitions=JSON.parse(await readFile("scripts/maintenance-batch-20260813-005034.json","utf8"));
