...
const slugs=["us-productivity-up-1-4-percent-labor-share-record-low-q2-2026","nsf-47-million-four-year-industry-integrated-phd-pilot-2026","nih-midlife-brain-immune-cell-shift-hippocampus-study-2026","nsf-50-million-ai-materials-innovation-platforms-2026","noaa-30-day-west-coast-ocean-acidification-survey-2026","us-open-oura-rings-main-draw-players-five-year-deal-2026"];
...
const articleEvidence=articles.map((article)=>({articleId:article.id,bodySha256:sha256(Buffer.from(article.body)),dek:article.dek,headline:article.headline,route:new URL(article.canonicalUrl).pathname}));const routes=["/","/rss.xml","/sitemap.xml","/news-sitemap.xml","/search/","/robots.txt","/business/","/us/","/health-science/","/technology/","/weather-climate/","/sports/",...(phase==="activation"?["/games/"]:[]),...articleEvidence.map(({route})=>route)];
