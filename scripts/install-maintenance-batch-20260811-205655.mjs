...
const mediaRoot="/media/newsroom/2026/08/manual-20260811-205655";
...
const articleDefs=JSON.parse(readFileSync(join(root,"scripts/maintenance-batch-20260811-205655.json"),"utf8"));
...
if(articleDefs.length!==6)throw new Error(`Exactly six definitions required, found ${articleDefs.length}`);
if(new Set(articleDefs.map(({desk})=>desk)).size!==6)throw new Error("Six distinct desks are required");
