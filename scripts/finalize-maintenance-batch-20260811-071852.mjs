...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-071852.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T071852Z-8D3E6B1A9C42";
const slugs=[
  "state-overseas-housing-standards-35-years-gao",
  "fed-july-2026-bank-lending-standards-demand",
  "nih-human-cancer-models-665-25-tumor-types",
  "smithsonian-bronze-bison-national-mall-exhibitions-2026",
  "ncaa-womens-flag-football-championship-funding-vote-2026",
  "who-global-health-days-evaluation-108-observances"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t071852z-8d3e6b1a9c42",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t071852z-8d3e6b1a9c42";
