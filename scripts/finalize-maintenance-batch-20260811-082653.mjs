...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-082653.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T082653Z-3A9F6C2D8E14";
const slugs=[
  "gao-critical-isotope-supply-risks-2026",
  "federal-escape-offenses-253-fiscal-2025",
  "gao-treasury-28-priority-recommendations-2026",
  "gao-wildlife-refuge-resilience-project-goals-125-million",
  "nist-secure-remote-access-water-utilities-three-designs",
  "us-traffic-death-rate-first-quarter-2026-nhtsa"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t082653z-3a9f6c2d8e14",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t082653z-3a9f6c2d8e14";
