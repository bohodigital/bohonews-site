...
const mediaRoot="/media/newsroom/2026/08/manual-20260811-144754";
...
const articleDefs=JSON.parse(readFileSync(join(root,"scripts/maintenance-batch-20260811-144754.json"),"utf8"));
