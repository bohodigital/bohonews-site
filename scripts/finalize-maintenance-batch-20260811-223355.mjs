...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-223355.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T223355Z-C8E4B1D7A2F6";
const slugs=["nrc-rulemaking-procedure-modernization-2026","cra-bank-size-thresholds-proposal-2026","nist-nvd-ai-modernization-rfi-2026","national-parks-powered-micromobility-rule-2026","nsf-pesose-open-source-grants-2026","fda-fresh-cut-produce-safety-guidance-2026"];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t223355z-c8e4b1d7a2f6",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t223355z-c8e4b1d7a2f6";
