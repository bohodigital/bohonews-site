...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260810-160849.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260810T160849Z-E5EFE15D24A7";
const slugs=[
  "gao-improper-payments-va-medicare-24-billion-2026",
  "ussc-national-defense-cases-517-fiscal-2025",
  "cbo-federal-credit-cost-methods-67-billion-gap-2027",
  "nsf-project-triad-quantum-sensors-networks-computers-2026",
  "nasa-brown-carbon-wildfire-smoke-july-2026",
  "imf-kazakhstan-growth-4-6-inflation-10-2026"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260810t160849z-e5efe15d24a7",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260810t160849z-e5efe15d24a7";
