...
const mediaRoot="/media/newsroom/2026/08/manual-20260811-025921";
...
const articleDefs=JSON.parse(readFileSync(join(root,"scripts/maintenance-batch-20260811-025921.json"),"utf8"));
