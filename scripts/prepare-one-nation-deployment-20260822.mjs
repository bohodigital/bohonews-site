...
if (!article) throw new Error("The exact One Nation article is unavailable");
if (sha256(Buffer.from(article.body)) !== "8f5e169d30883767d61520ff0791e4ac7dba39f059432eb4f59a49e3c8563cde") {
  throw new Error("The approved One Nation body bytes drifted");
}
...
const routes = [
  ...
  "/evidence/one-nation-network/",
  "/evidence/one-nation-network/bibliography.json",
  "/evidence/one-nation-network/v1.0.0/manifest.json",
  ...Array.from({ length: 11 }, (_, index) => `/evidence/one-nation-network/figures/${index + 1}/`),
];
const request = {
  schemaVersion: "1.0.0",
  batchId,
