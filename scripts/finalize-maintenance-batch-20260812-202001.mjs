...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260812-202001.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260812T202001Z-A7C3E9B2D6F4";
const slugs=["mspb-federal-employee-appeals-jurisdiction-2026","nepal-cultural-property-us-import-restrictions-2026","faa-boeing-787-vertical-fin-corrosion-proposal-2026","belt-railway-chicago-ptc-maintenance-request-2026","nih-dna-methylation-cancer-classifier-license-2026","us-mint-trump-dollar-coin-roll-bag-prices-2026"];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260812t202001z-a7c3e9b2d6f4",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260812t202001z-a7c3e9b2d6f4";
