...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-012221.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T012221Z-9D6B3F2A71C4";
const slugs=[
  "coast-guard-cleanup-liabilities-448-million-gao-2026",
  "tribal-law-enforcement-violent-offenses-down-11-percent-2023",
  "library-congress-gil-evans-manuscripts-unrecorded-scores",
  "cbo-president-2027-budget-defense-nondefense-spending",
  "imf-tanzania-444-million-final-program-reviews-2026",
  "mlb-draft-2026-first-day-135-picks-position-breakdown"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t012221z-9d6b3f2a71c4",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t012221z-9d6b3f2a71c4";
