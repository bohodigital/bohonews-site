...
const mediaRoot="/media/newsroom/2026/08/manual-20260810-174920";
...
const articleDefs=JSON.parse(readFileSync(join(root,"scripts/maintenance-batch-20260810-174920.json"),"utf8"));
