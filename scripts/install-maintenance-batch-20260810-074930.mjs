...
const mediaRoot="/media/newsroom/2026/08/manual-20260810-074930";
...
const articleDefs=JSON.parse(readFileSync(join(root,"scripts/maintenance-batch-20260810-074930.json"),"utf8"));
