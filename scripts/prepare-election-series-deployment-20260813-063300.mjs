...
const definitions = JSON.parse(
    readFileSync(
      join(root, "scripts/election-series-batch-20260813-063300.json"),
      "utf8",
    ),
  ),
...
if (articles.some((article) => !article) || articles.length !== 10)
  throw new Error("Exact election-series article inventory unavailable");
