...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-190455.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T190455Z-A6D3F9C2B7E4";
const slugs=[
  "fda-digital-breast-tomosynthesis-class-ii-proposal-2026",
  "sec-overnight-stock-price-bands-december-2026",
  "fmcsa-english-proficiency-out-of-service-proposal-2026",
  "faa-military-pilot-trainee-medical-certificate-proposal-2026",
  "national-gallery-mining-film-series-august-2026",
  "epa-dichlorobenzene-draft-risk-evaluations-2026"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t190455z-a6d3f9c2b7e4",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t190455z-a6d3f9c2b7e4";
