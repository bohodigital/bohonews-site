...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-001321.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T001321Z-0B750F8E9561";
const slugs=[
  "us-productivity-up-1-4-percent-labor-share-record-low-q2-2026",
  "nsf-47-million-four-year-industry-integrated-phd-pilot-2026",
  "nih-midlife-brain-immune-cell-shift-hippocampus-study-2026",
  "nsf-50-million-ai-materials-innovation-platforms-2026",
  "noaa-30-day-west-coast-ocean-acidification-survey-2026",
  "us-open-oura-rings-main-draw-players-five-year-deal-2026"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t001321z-0b750f8e9561",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t001321z-0b750f8e9561";
