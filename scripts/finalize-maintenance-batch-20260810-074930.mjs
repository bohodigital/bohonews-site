...
if (!activationInputPath) throw new Error("Usage: node scripts/finalize-maintenance-batch-20260810-074930.mjs <evidence-dir> <activation-evidence-input.json>");
...
const slugs = [
  "gao-va-disability-ai-modernization-15-open-actions-2026",
  "bjs-violent-offense-rate-370-8-per-100000-2024",
  "gao-277-open-recommendations-congress-2026",
  "2026-us-open-player-field-sabalenka-alcaraz-sinner-pegula",
  "library-congress-accessible-library-awards-georgia-massachusetts-2026",
  "alzheimers-circular-rna-blood-biomarkers-symptom-risk-2026"
];
...
const approval = {
  ...
  batchId: "PB-20260810T074930Z-BE1BD1000061",
  decision: "approved",
...
const requiredActivationFields = [
  "activationArtifactSha256", "activationInventorySha256", "activationProviderResponseHash",
  "activationImmutableUrl", "providerActivatedAt", "canonicalFirstPublicAt",
  "canonicalFirstPublicEvidenceHash", "previousVerifiedDeploymentReference",
  "edgeRouterContractVersion", "edgeRouterScriptHash", "edgeRouterDeploymentResponseHash",
  "edgeRouterActivatedAt", "edgeRouterOriginImmutableUrl", "edgeRouterOriginDeploymentReference",
  "edgeRouterVerificationHash"
];
if (Object.keys(activationInput).sort().join("\n") !== [...requiredActivationFields].sort().join("\n")) {
  throw new Error("Activation evidence input has an unexpected shape");
}
const activationEvidence = {
  schemaVersion: "1.2.0",
  recordId: "activation-evidence-pb-20260810t074930z-be1bd1000061",
  batchId: "PB-20260810T074930Z-BE1BD1000061",
...
const releaseId = "release-pb-20260810t074930z-be1bd1000061";
const releaseRecord = {
