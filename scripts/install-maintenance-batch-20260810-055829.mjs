...
const mediaRoot="/media/newsroom/2026/08/manual-20260810-055829";
...
void legacyArticleDefs;
const articleDefs=JSON.parse(readFileSync(join(root,"scripts/maintenance-batch-20260810-055829.json"),"utf8"));
