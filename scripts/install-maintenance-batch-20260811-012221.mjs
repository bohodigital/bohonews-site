...
const mediaRoot="/media/newsroom/2026/08/manual-20260811-012221";
...
const articleDefs=JSON.parse(readFileSync(join(root,"scripts/maintenance-batch-20260811-012221.json"),"utf8"));
