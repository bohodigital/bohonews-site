...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260810-174920.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260810T174920Z-A64D2E91C7F3";
const slugs=[
  "moab-uranium-cleanup-cost-116-billion-2026",
  "mandatory-minimums-applied-15-percent-federal-sentences-fy2025",
  "us-population-growth-slowed-05-percent-migration-2025",
  "nasa-adds-eight-commercial-earth-data-providers-2026",
  "drought-covered-4854-percent-lower-48-august-2026",
  "imf-uzbekistan-growth-68-percent-inflation-eases-2026"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260810t174920z-a64d2e91c7f3",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260810t174920z-a64d2e91c7f3";
