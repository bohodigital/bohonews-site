...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-132424.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T132424Z-6F1A9D3C8E52";
const slugs=[
  "hybrid-electric-saab-340-flight-above-30000-feet",
  "nasa-sweet-15-wing-failed-127-percent-design-load",
  "sec-regulation-e-delivery-paper-opt-out-proposal-2026",
  "italy-growth-05-percent-inflation-29-imf-2026",
  "education-department-title-vi-disparate-impact-provisions-2026",
  "who-kala-azar-14-day-treatment-guidelines-2026"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t132424z-6f1a9d3c8e52",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t132424z-6f1a9d3c8e52";
