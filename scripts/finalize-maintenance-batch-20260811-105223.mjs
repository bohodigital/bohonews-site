...
if(!activationInputPath)throw new Error("Usage: node scripts/finalize-maintenance-batch-20260811-105223.mjs <evidence-dir> <activation-evidence-input.json>");
...
const batchId="PB-20260811T105223Z-4D8A1C7E9B30";
const slugs=[
  "federal-supervised-release-rate-fell-82-percent-fy2025",
  "gao-federal-strategic-reviews-requirements-2026",
  "cbo-social-security-one-time-wealth-tax-75-year-solvency",
  "prescribed-burns-sequoia-survival-nasa-study-2026",
  "nist-looping-laser-mixes-3d-printed-alloys-2026",
  "public-pension-assets-649-trillion-census-2025"
];
...
const activationEvidence={schemaVersion:"1.2.0",recordId:"activation-evidence-pb-20260811t105223z-4d8a1c7e9b30",batchId,adapterId:"bohonews.article.v2",approvalDigest,candidatePackageDigest:promotion.packageDigest,...activationInput};
activationEvidence.recordHash=digest(activationEvidence);
const releaseId="release-pb-20260811t105223z-4d8a1c7e9b30";
