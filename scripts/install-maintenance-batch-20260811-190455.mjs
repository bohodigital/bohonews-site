...
const mediaRoot="/media/newsroom/2026/08/manual-20260811-190455";
...
const articleDefs=JSON.parse(readFileSync(join(root,"scripts/maintenance-batch-20260811-190455.json"),"utf8"));
