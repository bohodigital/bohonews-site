...
if (!['activation','final'].includes(phase) || !sourceDistArg || !outputArg || !batchId || !expectedCommit || !previousReference) {
  throw new Error('Usage: node scripts/prepare-maintenance-deployment-20260810-051729.mjs <activation|final> <dist> <output> <batch-id> <commit> <previous-reference>');
}
...
const routes = [
  ...
  '/investigations/', '/crime-justice/', '/politics/', '/sports/', '/weather-climate/', '/world/',
