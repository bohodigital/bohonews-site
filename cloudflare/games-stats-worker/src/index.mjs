...
const CONTRACTS = {
  ...
  solitaire: { variants: new Set(["draw-1", "draw-3"]), outcomes: new Set(["solved"]), scores: POINT_BUCKETS },
  freecell: { variants: new Set(["standard"]), outcomes: new Set(["solved"]), scores: POINT_BUCKETS },
  spider: { variants: new Set(["1-suit", "2-suit", "4-suit"]), outcomes: new Set(["solved"]), scores: POINT_BUCKETS },
  pyramid: { variants: new Set(["standard"]), outcomes: new Set(["solved"]), scores: POINT_BUCKETS },
  tripeaks: { variants: new Set(["standard"]), outcomes: new Set(["solved"]), scores: POINT_BUCKETS },
